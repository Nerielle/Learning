...
namespace theworld.Models
{
    public class WorldContextSeedData
    {
        ...
        {
            var email = "sam.hasting@theworld.com";
            var userName = "samhastings";
            ...
            if (!worldContext.Trips.Any())
            {
                ...
                worldContext.Add(usTrip);
                worldContext.AddRange(usTrip.Stops);
                ...
                worldContext.Add(worldTrip);
                worldContext.AddRange(worldContext.Stops);
